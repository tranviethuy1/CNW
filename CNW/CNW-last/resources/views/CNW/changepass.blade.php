              ...
              @endif
					...
					<div class="form-group"><label class="col-md-4 control-label" for="Email">Email</label>  
           				<div class="col-md-4">
                			...
                			<input id="Email" name="email" type="text" class="form-control input-md" value ="" disabled>
              				</div>
            			</div>
          			</div>
          			<!-- password -->
          			...
          			<div class="form-group">
			        	...
			        	<a href="" class="btn btn-danger" ><span class="glyphicon glyphicon-remove-sign"></span>Back to Home</a>
          				</div>
       				 </div>
				</form>			
			</div>
